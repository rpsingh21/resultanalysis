...
class MarksAdminModel(admin.ModelAdmin):
    list_display = ['student', 'backStatus',
                    'subjectCode', 'internal', 'external']
    search_fields = ['student__rollNo', 'student__name',
                     'subjectCode__subjectName', 'internal', 'external']
...
class TotalMarksAdminModel(admin.ModelAdmin):
    ...
    search_fields = ['student__rollNo', 'student__name',
                     'semester', 'totalMarks', 'internal', 'external']


class StudentAdminModel(admin.ModelAdmin):
    list_display = ['rollNo', 'name', 'college', 'branchCode', 'yearOfJoining']
    search_fields = ['rollNo', 'name', 'college__collegeName',
                     'branchCode__branchCode', 'yearOfJoining']
